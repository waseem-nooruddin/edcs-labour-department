...
public class InternalManageCompaniesPage {
    private final WebDriver driver;

    public InternalManageCompaniesPage(WebDriver driver) {
        this.driver = driver;
    ...
    private void EnterNextButton() {
        driver.findElement(By.xpath("//*[@id=\"validation-forms\"]/div[2]/div/div[2]/div/div/button")).click();
    }
...
// Business Details //
    ...
    private void AddApplicantName(String ApplicantName) {
        driver.findElement(By.id("applicantName")).sendKeys(ApplicantName);
    }
